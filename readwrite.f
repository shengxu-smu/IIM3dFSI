...
c
      ...
      rewind 11
      read(11)nstart,t,t0
      read(11)xsc,ysc,zsc,pitch,yaw,roll
      read(11)xs,ys,zs,xse,yse,zse,us,vs,ws,use,vse,wse
...
c
     ...
     .     status='unknown')
      rewind 12
      write(12)nend,t,t0
      write(12)xsc,ysc,zsc,pitch,yaw,roll
      write(12)xs,ys,zs,xse,yse,zse,us,vs,ws,use,vse,wse
