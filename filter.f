c-----------------------------------------------------------------------
c
      subroutine filter(f,mn,n1c,n2c)
      include 'parameter.inc'
      include 'surface.inc'
      include 'fft.inc'
      integer isphr,nh,nd,n1c,n2c,mn,nonlinear,nc
      parameter(nd=2*ns1+2,nh=ns2/2) 
      real*8 f(0:ns1,0:ns2,mn)
...
c
      ...
      do m2=1,nh
        do m1=1,ns1+1
          r3(m2,m1)=f(m1-1,m2-1,m)
        enddo
        do m1=ns1+2,nd
          r3(m2,m1)=f(nd-m1,m2+nh-1,m)
        enddo
      enddo
